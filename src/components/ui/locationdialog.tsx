...
const LocationDialog: React.FC<LocationDialogProps> = ({
    ...
    return (
        ...
        >
            <div className="max-h-[400px] w-[400px] overflow-auto">
                <h1 className="font-bold text-[16px] mt-1 mb-2">{location.nama_lokal.toUpperCase()}</h1>
                <div className="grid grid-cols-3 gap-1">
                    <div className="space-y-2">
                        <p><strong>Nama Lokal</strong></p>
                        <p><strong>Nama Spesifik</strong></p>
                        <p><strong>Nama Peta</strong></p>
                        <p><strong>Klasifikasi</strong></p>
                        <p><strong>Unsur</strong></p>
                        <p><strong>Kecamatan</strong></p>
                        <p><strong>Desa</strong></p>
                ...
                {location.Detailtoponim && (
                    <>
                        ...
                        <div className="grid grid-cols-3 gap-1">
                            <div className="space-y-2">
                                <p><strong>Nama Gazeter</strong></p>
                                <p><strong>Nama Lain</strong></p>
                                <p><strong>Arti Nama</strong></p>

                                <p><strong>Klasifikasi</strong></p>
                                <p><strong>Unsur</strong></p>
                                <p><strong>Zona UTM</strong></p>
                                <p><strong>NLP</strong></p>
                                <p><strong>L-Code</strong></p>
                                <p><strong>Sejarah Nama</strong></p>
                            </div>
                            <div className="space-y-2 col-span-2">
